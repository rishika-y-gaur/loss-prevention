...
declare -a REQUIRED_MODELS=(
    ...
    "object_classification/age-gender-recognition-retail-0013/FP32/age-gender-recognition-retail-0013.bin"
    "object_classification/age-gender-recognition-retail-0013/FP32/age-gender-recognition-retail-0013.xml"
    ...
    "object_detection/face-detection-retail-0004/FP32/face-detection-retail-0004.bin"
    "object_detection/face-detection-retail-0004/FP32/face-detection-retail-0004.xml"
